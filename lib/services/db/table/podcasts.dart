...
class Podcasts extends Table {
  ...
  BoolColumn get cachedAllEpisodes => boolean().nullable()();
...
PodcastRow podcastRowFromModel(Podcast model) {
  return PodcastRow(
    ...
    cachedAllEpisodes: model.cachedAllEpisodes,
    cacheUpdatedAt: model.cacheUpdatedAt ?? DateTime.now(),
  );
}
...
extension PodcastRowExtension on PodcastRow {
  Podcast toModel() {
    return Podcast(
      ...
      feedLastRefreshAt: '',
      isSubscribed: false,
      cachedAllEpisodes: cachedAllEpisodes ?? false,
